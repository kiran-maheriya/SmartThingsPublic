...
metadata {
    ...
    preferences {
        input description: "After changes are made, the configuration icon will show an orange dot until all configuration parameters are updated.", title: "Settings", displayDuringSetup: false, type: "paragraph", element: "paragraph"
...
<Value type="list" byteSize="1" index="1" label="Input 1: Switch Type" min="0" max="1" value="1" setting_type="zwave" fw="">
 <Help>
Range: 0 to 1
Default: Bi-stable (Toggle) switch
</Help>
        <Item label="Momentary (Push button) switch" value="0" />
        <Item label="Bi-stable (Toggle) switch" value="1" />
</Value>
...
Default: 0 (NO - Normally Open)
        ...
        <Item label="NO (normally open) input" value="0" />
        <Item label="NC (normally closed) input" value="1" />
</Value>
...
<Value type="list" byteSize="1" index="100" label="Input 2: Disable / select Device" min="0" max="9" value="9" setting_type="zwave" fw="" hidden="true">
 <Help>
Range: 0 to 6, 9
...
<Value type="list" byteSize="1" index="101" label="Input 3: Disable / select Device" min="0" max="9" value="0" setting_type="zwave" fw="" hidden="true">
 <Help>
Range: 0 to 6, 9
Default: 0 (Disabled)
</Help>
...
<Value type="list" byteSize="1" index="i2" label="Input 2: Disable / select Device Type Handler" min="0" max="9" value="Contact Sensor Child Device" setting_type="preference" fw="">
 <Help>
Default: Contact Sensor Child Device
</Help>
...
<Value type="list" byteSize="1" index="i3" label="Input 3: Disable / select Device Type Handler" min="0" max="9" value="Disabled" setting_type="preference" fw="">
 <Help>
Default: Disabled
</Help>
        <Item label="Disabled" value="Disabled" />
...
<Value type="list" byteSize="2" index="10" label="Activate / deactivate functions ALL ON/ALL OFF" min="0" max="255" value="0" setting_type="zwave" fw="">
 <Help>
ALL ON active
Range: 0, 1, 2, 255
Default: ALL ON is not active, ALL OFF is not active
</Help>
